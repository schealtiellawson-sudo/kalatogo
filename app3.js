...
(function(){
  ...
  function buildOnboarding(){
    ...
    var steps = [
      ...
      { icon:'trophy',     title:'500 000 FCFA versés chaque mois.', text:"Pas une promesse. Un virement. Bourse de Croissance 300K (1 gagnant/mois, Pro) pour les pros sérieux. Bourse des Mains d'Or 200K (100K × 2 Reines, 1 Togo + 1 Bénin) pour les femmes coiffeuses et couturières. Premier tirage le 31 juillet 2026. Ton travail te paye enfin.", primary:'Suivant' },
