...
// GET  /api/wozali-pay/feed-discover?mode=swipe|duel|roulette&categorie=&viewer_id=&voter_session=&batch=10
// POST /api/wozali-pay/feed-discover  Body: { winner_id, loser_id, voter_id?, voter_session? }
//
// v2 (2026-04-28) :
...
//  - Enrichit depuis wozali_prestataires (au lieu de profiles)
