...
// POST /api/wozali-pay/health-metrics    (CRON-only via X-Cron-Secret)
//
// 1. Agrège les erreurs des dernières 24h par heure dans wozali_health_metrics
...
<div style="max-width:560px;margin:0 auto;padding:32px 24px;">
  ...
  <div style="margin-top:24px;padding-top:18px;border-top:1px solid rgba(232,148,10,0.2);font-size:12px;color:rgba(248,246,241,0.5);">
    Voir les logs : Supabase → table <code>wozali_errors_log</code>.<br>
