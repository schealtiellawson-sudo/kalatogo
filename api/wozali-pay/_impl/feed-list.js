...
// GET /api/wozali-pay/feed-list?mois=&ville=&quartier=&categorie=&tri=&user_id=&limit=&offset=
// ================================================================
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Enrichir avec wozali_prestataires (nom + avatar + métier + statut artisan)
