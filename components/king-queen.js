// ══════════════════════════════════════════
// King & Queen WOZALI — Concours beauté/charme mensuel
...
(function(){
  ...
  function render(){
    ...
    if (!root) return;
    root.innerHTML = `
      <div class="kq-container" style="color:#FCE0A8;font-family:'Geist',sans-serif;max-width:1100px;margin:0 auto;padding:0 16px;">
        ${heroHTML()}
        ${tabsHTML()}
  ...
  function heroHTML(){
    return `
      <div style="background:linear-gradient(135deg,#14100A 0%,#1a1f1a 100%);border:1px solid rgba(232,148,10,.3);border-radius:20px;padding:32px 24px;margin:16px 0 24px;position:relative;overflow:hidden;">
        ...
        <div style="font-family:'Geist Mono',monospace;font-size:11px;letter-spacing:3px;color:#E8940A;margin-bottom:10px;">NOUVEAU · CHAQUE MOIS</div>
        ...
        <div style="background:rgba(232,148,10,.06);border:1px solid rgba(232,148,10,.2);border-radius:14px;padding:16px 18px;margin-bottom:18px;max-width:720px;">
          ...
          <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:12px;">
            <div style="display:flex;align-items:flex-start;gap:10px;">
              ...
              <div>
                <div style="font-weight:700;font-size:13px;color:#FCE0A8;margin-bottom:2px;">1. Poste tes 3 photos</div>
                <div style="font-size:12px;color:rgba(252, 224, 168,.6);line-height:1.5;">Selfie, tenue, charme. Hommes et femmes. Zéro catégorie, juste toi.</div>
              </div>
            </div>
            <div style="display:flex;align-items:flex-start;gap:10px;">
              <span style="font-size:20px;flex-shrink:0;">⚔️</span>
              <div>
                <div style="font-weight:700;font-size:13px;color:#FCE0A8;margin-bottom:2px;">2. La communauté swipe et vote</div>
                <div style="font-size:12px;color:rgba(252, 224, 168,.6);line-height:1.5;">Duels infinis. Swipe pour voter. Tout le monde vote, hommes et femmes.</div>
              </div>
            </div>
            <div style="display:flex;align-items:flex-start;gap:10px;">
              <span style="font-size:20px;flex-shrink:0;">👑</span>
              <div>
                <div style="font-weight:700;font-size:13px;color:#FCE0A8;margin-bottom:2px;">3. Duel final TG vs BJ</div>
                <div style="font-size:12px;color:rgba(252, 224, 168,.6);line-height:1.5;">Le meilleur homme → <strong style="color:#E8940A;">King 50 000 F</strong>. La meilleure femme → <strong style="color:#E8940A;">Queen 50 000 F</strong>.</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div style="display:flex;gap:12px;flex-wrap:wrap;">
          <div style="background:rgba(232,148,10,.08);border:1px solid rgba(232,148,10,.2);border-radius:12px;padding:12px 16px;text-align:center;min-width:120px;">
            ...
            <div style="font-size:11px;color:rgba(252, 224, 168,.6);">👑 King du mois</div>
          </div>
          <div style="background:rgba(232,148,10,.08);border:1px solid rgba(232,148,10,.2);border-radius:12px;padding:12px 16px;text-align:center;min-width:120px;">
            <div style="font-family:'Fraunces',serif;font-size:22px;font-weight:900;color:#E8940A;">50 000 F</div>
            <div style="font-size:11px;color:rgba(252, 224, 168,.6);">👑 Queen du mois</div>
          </div>
          <button onclick="showPage('dashboard');setTimeout(()=>showDashSection('abonnement'),300)" style="background:#E8940A;color:#14100A;border:none;padding:12px 20px;border-radius:12px;font-weight:800;font-size:13px;cursor:pointer;min-width:120px;">Passer au Pro →</button>
        </div>
      </div>
    `;
  }
  ...
  function tabsHTML(){
    ...
    return `
      <div style="display:flex;gap:8px;overflow-x:auto;padding-bottom:4px;margin-bottom:12px;scrollbar-width:none;">
        ${tabs.map(t => `
          <button onclick="kqChangeTab('${t.id}')" style="flex-shrink:0;padding:10px 18px;border-radius:999px;border:1px solid ${state.tab === t.id ? '#E8940A' : 'rgba(232,148,10,.25)'};background:${state.tab === t.id ? '#E8940A' : 'transparent'};color:${state.tab === t.id ? '#14100A' : '#FCE0A8'};font-weight:700;font-size:13px;cursor:pointer;white-space:nowrap;">
            ${t.lbl}
          </button>
        `).join('')}
      </div>
  ...
  function accueilHTML(){
    return `
      <div style="text-align:center;padding:40px 0;">
        ...
        <p style="color:rgba(252, 224, 168,.7);max-width:480px;margin:0 auto 24px;font-size:15px;line-height:1.7;">
        ...
        <div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap;">
          <button onclick="kqChangeTab('duels')" style="padding:16px 32px;background:#E8940A;color:#14100A;border:none;border-radius:14px;font-weight:900;font-size:16px;cursor:pointer;">⚔️ Commencer les duels</button>
        ...
        <div style="margin-top:40px;display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:16px;max-width:700px;margin-left:auto;margin-right:auto;">
          <div style="background:rgba(232,148,10,.06);border:1px solid rgba(232,148,10,.15);border-radius:14px;padding:20px;">
            ...
            <div style="font-size:13px;color:rgba(252, 224, 168,.6);line-height:1.5;">Swipe autant que tu veux. 3 heures si ça te chante. Tant qu'il y a des participants, il y a des duels.</div>
          </div>
          <div style="background:rgba(232,148,10,.06);border:1px solid rgba(232,148,10,.15);border-radius:14px;padding:20px;">
            <div style="font-size:32px;margin-bottom:8px;">🌍</div>
            <div style="font-family:'Fraunces',serif;font-size:18px;font-weight:900;margin-bottom:4px;">Togo vs Bénin</div>
            <div style="font-size:13px;color:rgba(252, 224, 168,.6);line-height:1.5;">À la fin du mois, le meilleur de chaque pays s'affronte. Le gagnant représente son pays.</div>
          </div>
          <div style="background:rgba(232,148,10,.06);border:1px solid rgba(232,148,10,.15);border-radius:14px;padding:20px;">
            <div style="font-size:32px;margin-bottom:8px;">💰</div>
            <div style="font-family:'Fraunces',serif;font-size:18px;font-weight:900;margin-bottom:4px;">100 000 F</div>
            <div style="font-size:13px;color:rgba(252, 224, 168,.6);line-height:1.5;">50 000 F pour le King. 50 000 F pour la Queen. Chaque mois. Réservé aux Pro 2+ mois.</div>
          </div>
        </div>
      </div>
    `;
    ...
    if (!pair) {
      return `
        <div style="text-align:center;padding:40px 20px;">
          ...
          <p style="color:rgba(252, 224, 168,.6);margin-bottom:6px;">Série actuelle : ${state.duelStreak} 🔥</p>
          <div style="background:rgba(232,148,10,.06);border:1px solid rgba(232,148,10,.2);border-radius:14px;padding:16px;margin:16px auto;max-width:400px;">
            ...
            <div style="display:flex;gap:8px;justify-content:center;flex-wrap:wrap;">
              ...
              <button onclick="kqCopyLink()" style="padding:10px 18px;background:rgba(255,255,255,.06);color:#FCE0A8;border:1px solid rgba(232,148,10,.25);border-radius:999px;font-weight:700;cursor:pointer;font-size:13px;">📋 Copier le lien</button>
            </div>
            <p style="font-size:11px;color:rgba(252, 224, 168,.4);margin:8px 0 0;text-align:center;">Plus il y a de votants, plus la couronne a de valeur.</p>
          </div>
          <button onclick="kqReloadDuels()" style="margin-top:12px;padding:12px 28px;background:#E8940A;color:#14100A;border:none;border-radius:999px;font-weight:700;cursor:pointer;">⚔️ Continuer les duels</button>
        </div>
      `;
    }
    ...
    return `
      <div style="max-width:720px;margin:0 auto;">
        <div style="text-align:center;margin-bottom:12px;">
          <div style="font-family:'Geist Mono',monospace;font-size:11px;color:rgba(252, 224, 168,.5);margin-bottom:4px;">DUEL ${state.duelCount + 1} · Série : ${state.duelStreak} 🔥</div>
          <div style="font-family:'Fraunces',serif;font-size:22px;font-weight:900;">Qui tu préfères ?</div>
          <div style="font-size:12px;color:rgba(252, 224, 168,.5);margin-top:4px;">Clique sur ta préférence. C'est instantané.</div>
        </div>

        <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;position:relative;" id="kq-duel-grid">
          ${duelCardHTML(a, 'a')}
          <div style="position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);background:#14100A;border:2px solid #E8940A;border-radius:50%;width:48px;height:48px;display:flex;align-items:center;justify-content:center;font-weight:900;color:#E8940A;font-size:14px;z-index:5;">VS</div>
          ${duelCardHTML(b, 'b')}
        </div>

        <div style="display:flex;justify-content:center;gap:8px;margin-top:16px;">
          <button onclick="kqSkipDuel()" style="padding:10px 20px;border-radius:999px;border:1px solid rgba(252, 224, 168,.15);background:transparent;color:rgba(252, 224, 168,.6);cursor:pointer;font-size:13px;">⏭️ Passer</button>
        ...
        ${state.duelCount > 0 && state.duelCount % 5 === 0 ? `
          <div style="background:rgba(37,211,102,.06);border:1px solid rgba(37,211,102,.25);border-radius:14px;padding:14px;margin-top:16px;text-align:center;max-width:500px;margin-left:auto;margin-right:auto;">
            ...
            <div style="font-size:12px;color:rgba(252, 224, 168,.5);">Envoie le lien sur WhatsApp — plus on vote, plus c'est chaud 🔥</div>
  ...
  function duelCardHTML(p, side){
    return `
      <button onclick="kqVoteDuel('${p.id}','${side}')" class="kq-duel-card" style="padding:0;border:2px solid rgba(232,148,10,.2);background:#14100A;border-radius:16px;overflow:hidden;cursor:pointer;transition:all .2s;position:relative;" onmouseenter="this.style.borderColor='#E8940A';this.style.transform='scale(1.02)'" onmouseleave="this.style.borderColor='rgba(232,148,10,.2)';this.style.transform='scale(1)'">
        <div style="aspect-ratio:3/4;background:#1a1f1a url('${esc(p.photo_url)}') center/cover;"></div>
        <div style="padding:12px 14px;text-align:left;color:#FCE0A8;">
          <div style="font-family:'Fraunces',serif;font-size:16px;font-weight:900;margin-bottom:2px;">${esc(p.user_nom)}</div>
          <div style="font-size:11px;color:rgba(252, 224, 168,.5);font-family:'Geist Mono',monospace;">
    ...
    return `
      <div style="display:flex;gap:8px;margin-bottom:16px;flex-wrap:wrap;">
        <div style="display:flex;gap:4px;">
          ${['femme','homme'].map(g => `
            <button onclick="kqSetGenre('${g}')" style="padding:8px 16px;border-radius:999px;border:1px solid ${state.classementGenre === g ? '#E8940A' : 'rgba(232,148,10,.2)'};background:${state.classementGenre === g ? 'rgba(232,148,10,.15)' : 'transparent'};color:${state.classementGenre === g ? '#E8940A' : '#FCE0A8'};font-weight:700;cursor:pointer;font-size:13px;">
        ...
        <div style="display:flex;gap:4px;">
          ${['tous','TG','BJ'].map(p => `
            <button onclick="kqSetPays('${p}')" style="padding:8px 14px;border-radius:999px;border:1px solid ${state.classementPays === p ? '#E8940A' : 'rgba(232,148,10,.2)'};background:${state.classementPays === p ? 'rgba(232,148,10,.15)' : 'transparent'};color:${state.classementPays === p ? '#E8940A' : '#FCE0A8'};font-weight:600;cursor:pointer;font-size:12px;">
      ...
      ${state.leaderboard.length === 0 ? `
        <div style="padding:40px;text-align:center;color:rgba(252, 224, 168,.5);">Pas encore de classement. Les premiers duels sont en cours.</div>
      ` : `
        ${state.leaderboard.length >= 3 ? topThreeHTML(state.leaderboard.slice(0, 3)) : ''}
        <div style="background:#14100A;border:1px solid rgba(232,148,10,.15);border-radius:14px;overflow:hidden;margin-top:16px;">
  ...
  function classementRowHTML(p, rang){
    ...
    return `
      <div style="display:flex;align-items:center;gap:12px;padding:12px 16px;border-bottom:1px solid rgba(232,148,10,.06);">
        <div style="width:32px;text-align:center;font-weight:900;color:${rang <= 3 ? '#E8940A' : 'rgba(252, 224, 168,.5)'};">${medal || rang}</div>
        ...
        <div style="text-align:right;">
          ...
          <div style="font-size:10px;color:rgba(252, 224, 168,.5);">wins</div>
        </div>
      </div>
    `;
  }
  ...
  function participerHTML(){
    if (!window.currentUser?.id) return `
      <div style="text-align:center;padding:40px;">
        ...
        <p style="color:rgba(252, 224, 168,.6);margin-bottom:16px;">Un compte WOZALI gratuit suffit pour jouer.</p>
        <button onclick="if(typeof verifierConnexionOuPopup==='function'){verifierConnexionOuPopup('participer au King & Queen');}else{window.showPage&&window.showPage('inscription');}" style="padding:14px 28px;background:#E8940A;color:#14100A;border:none;border-radius:999px;font-weight:700;cursor:pointer;">Créer mon compte</button>
      </div>
    `;
    ...
    return `
      <div style="max-width:600px;margin:0 auto;">
        <div style="text-align:center;margin-bottom:24px;">
          ...
          <p style="color:rgba(252, 224, 168,.7);font-size:14px;">3 photos obligatoires pour participer aux duels.</p>
        ...
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:24px;">
          ${[0,1,2].map(i => {
            ...
            return `
              <button onclick="kqOpenUpload(${i+1})" style="aspect-ratio:3/4;border-radius:14px;border:2px dashed rgba(232,148,10,.3);background:rgba(232,148,10,.04);display:flex;flex-direction:column;align-items:center;justify-content:center;cursor:pointer;color:rgba(252, 224, 168,.5);gap:8px;">
        ...
        <div style="background:rgba(232,148,10,.06);border:1px solid rgba(232,148,10,.15);border-radius:14px;padding:16px;margin-top:20px;">
          ...
          <div style="font-size:13px;color:rgba(252, 224, 168,.7);line-height:1.6;">
  ...
  function openUploadModal(slotNum){
    ...
    const html = `
      <div id="kq-upload-modal" style="position:fixed;inset:0;background:rgba(15,20,16,.96);z-index:9999;display:flex;align-items:flex-start;justify-content:center;padding:20px;overflow-y:auto;" onclick="if(event.target===this){this.remove();}">
        <div style="max-width:480px;width:100%;background:#14100A;border:1px solid rgba(232,148,10,.3);border-radius:20px;padding:24px;">
          <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:14px;">
            <div>
              <div style="font-size:11px;color:#E8940A;letter-spacing:2px;font-family:'Geist Mono',monospace;">PHOTO ${slotNum} / 3</div>
              <h2 style="margin:4px 0 0;font-family:'Fraunces',serif;font-size:22px;">King & Queen 👑</h2>
            </div>
            <button onclick="document.getElementById('kq-upload-modal').remove()" style="background:transparent;border:none;color:#FCE0A8;font-size:24px;cursor:pointer;">×</button>
          </div>
          <p style="font-size:13px;color:rgba(252, 224, 168,.6);margin-bottom:16px;">Selfie, tenue, charme — montre-toi sous ton meilleur jour. C'est TOI le sujet.</p>
          <input type="file" id="kqFile" accept="image/*" style="width:100%;padding:12px;border-radius:10px;border:1px dashed rgba(232,148,10,.3);background:rgba(232,148,10,.05);color:#FCE0A8;margin-bottom:14px;">
          ...
          <button onclick="kqSubmitPhoto(${slotNum})" id="kqSubmitBtn" style="width:100%;padding:14px;border-radius:12px;border:none;background:#E8940A;color:#14100A;font-weight:900;font-size:15px;cursor:pointer;">Poster la photo ${slotNum} ✨</button>
        </div>
      </div>
    `;
  ...
  // HELPERS
  // ──────────────────────────────────────────
  function skeletonHTML(){ return `<div style="padding:40px;text-align:center;color:rgba(252, 224, 168,.5);">Chargement…</div>`; }
  function loaderHTML(){ return `<div style="padding:40px;text-align:center;color:rgba(252, 224, 168,.5);">…</div>`; }
  function emptyHTML(msg){ return `<div style="padding:40px;text-align:center;"><div style="font-size:48px;margin-bottom:12px;">👑</div><h3 style="font-family:'Fraunces',serif;margin:0 0 6px;">${msg}</h3><button onclick="kqChangeTab('participer')" style="margin-top:16px;padding:12px 24px;background:#E8940A;color:#14100A;border:none;border-radius:999px;font-weight:700;cursor:pointer;">📸 Participer</button></div>`; }
