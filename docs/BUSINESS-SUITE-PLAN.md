# WOZALI Business Suite — Plan d'exécution
...
📱 MON ACTIVITÉ  (prestataire)
   Rendez-vous · Publications · Favoris & abonnements · Score WOZALI
...
🏢 MON ENTREPRISE  (patron — rôle conditionnel)
   ...
   │
   └─ FINANCES
       CA · Dépenses · WOZALI Pay Pro · Tableau de bord

💼 MON EMPLOI  (employé — rôle conditionnel)
   Contrat & employeur · Bulletins · Paiements · Annonces · Congés

🎯 WOZALI JOBS  (candidat)
   Mode dispo · Candidatures envoyées · Mon CV WOZALI

💰 WOZALI PAY
   Solde · Historique · Abonnement Pro

🎁 RÉCOMPENSES
   Bourse de croissance · WOZALI Awards
```
...
3. Plateforme génère token unique → `wozali.com/invite/<token>`
4. WhatsApp auto-ouvert : *"Salut Koffi, [Entreprise] t'invite à rejoindre son équipe sur WOZALI. Clique pour créer ton compte et recevoir tes salaires : <lien>"*
...
## 5. Paiement salaires via WOZALI Pay

### Pré-requis
Patron a un solde WOZALI Pay alimenté par mobile money (MoMo/Flooz/TMoney).
...
- Virement instantané WOZALI Pay → WOZALI Pay (0 frais entre comptes WOZALI)
- Employé reçoit simultanément :
  - Notif in-app : "Salaire avril reçu — 75 000 FCFA"
  - WhatsApp : "Ton salaire est sur ton WOZALI Pay. Retire sur MoMo/Flooz/TMoney."
...
### Bénéfices
- 0 frais entre WOZALI Pay (vs 1-2% MoMo)
- Traçabilité totale (audit, impôts, litiges)
- Fiche paie + virement en 1 étape
- Score Employeur WOZALI (crédit entreprise)
...
- Employé : nom, poste, matricule WOZALI
- Période : Mois/Année
- Détail : Salaire brut — Avances — Prélèvements CNSS (opt.) — Bonus — Retenues — **Net à payer**
- Pied : signature patron + mention "WOZALI Business"
...
4. Paiement en 1 clic → flow WOZALI Pay ci-dessus
...
| `Paiements_Salaire` | transactions WOZALI Pay patron→employé |
...
2. **WOZALI Pay** : accélérer MVP (prérequis paiements salaires)
3. **Sidebar conditionnelle** : menu selon rôle
4. **Landing `/invite/:token`** : nouvelle page publique
5. **Score WOZALI** : bonus ancienneté employé + bonus patron ponctuel
...
- **Phase C** — Module Équipe + invitation compte WOZALI
- **Phase D** — WOZALI Pay Payroll + fiches de paie
...
|---|---|---|
| **Solopreneur** (artisan seul, freelance) | Profil · CA · Dépenses · WOZALI Pay · Récompenses | Pas de module équipe, mais peut l'activer si embauche |
...
### Cumul de rôles (compte WOZALI polymorphe)

Un seul compte WOZALI peut cumuler :
...
**Tabs** :
1. **💰 Paiements** — timeline chronologique de tous les salaires reçus (mois / montant / statut / preuve WOZALI Pay)
...
Quand un utilisateur WOZALI devient employé :
1. **Zéro recréation** de compte — son compte WOZALI existant reçoit la nouvelle dimension
...
> **WOZALI te trouve des clients. WOZALI Business t'aide à grandir. WOZALI Emploi te connecte à tes employeurs.**
> Un pro qui utilise la suite entreprise devient 10× moins susceptible de partir. Sa croissance devient mesurable = argument d'acquisition pour les prochains pros. Un employé qui reçoit ses bulletins + salaires via WOZALI devient ambassadeur naturel de la plateforme auprès de sa communauté.
