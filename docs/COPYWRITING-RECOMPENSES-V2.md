...
3. Storytelling — 3 personnages
4. Copywriting — 3 versions chaque section
5. Hooks réseaux sociaux
6. Scripts TikTok / Reels — 10 vidéos prêtes à tourner
7. Email séquence — Drip 7 jours
8. Calendrier éditorial 30 jours pré-lancement
9. Charte brand voice — règles
10. Conclusion — ce qui rend la Bourse unique
...
### 1.2 La nouvelle vision

**Phrase noyau** : *"C'est pas le plus connu qui gagne. C'est le plus sérieux."*

La Bourse de Croissance n'est pas un concours de popularité. C'est pas un vote. C'est pas du buzz. C'est un algorithme qui regarde ton travail chaque jour et qui te paie chaque mois si tu fais ton boulot bien.

300 000 FCFA pour 1 pro au Togo + 300 000 FCFA pour 1 pro au Bénin. Chaque mois. Tirage 100% aléatoire le 30 parmi les éligibles. Pas de jury. Pas de subjectivité. Pas de favoritisme.

### 1.3 Comparaison avec Bourse des Mains d'Or

| | Bourse des Mains d'Or | Bourse de Croissance |
|---|---|---|
| **Cible** | Femmes coiffure/couture | Tous pros (h/f, tous métiers Pro) |
| **Mécanique** | Concours communautaire (votes + jury) | Tirage aléatoire algorithmique |
| **Critères** | Notoriété + qualité visible | Sérieux mesurable (score, avis, activité) |
| **Cadence** | Saisonnier / événementiel | Mensuel récurrent |
| **Énergie** | Célébration / mise en lumière | Récompense silencieuse du travail bien fait |

Les deux coexistent. L'une dit "viens te montrer". L'autre dit "fais ton boulot et l'algorithme s'occupe du reste".
...
Dans les marketplaces de services, **la réputation digitale est le seul actif qui rend un pro informel "scalable"**. Sans réputation portable, chaque nouveau client repart de zéro. Sans réputation portable, le bouche à oreille reste géographique (5 km autour de l'atelier).

Les marqueurs du pro sérieux dans les études comportementales :
- **Réponse rapide** : un pro qui répond en < 1h convertit 3× plus qu'un pro qui répond en 24h (donnée transposée de l'étude HubSpot 2024 sur lead response time, applicable aux marketplaces de services).
...
- **Activité récente** : un profil dormant depuis 30 jours perd 60 % de sa visibilité algorithmique sur la plupart des marketplaces (logique implémentée par Indeed, Yelp, Frizbiz).
...
**Conclusion opérationnelle** : la Bourse de Croissance récompense des comportements **mesurables** : score, avis, note, activité. Pas du subjectif.

### 2.2 Douleurs des pros TG/BJ — pourquoi 300 000 FCFA change tout

Contexte macro :
- **Bénin** : 90.1 % des emplois sont informels. Le sous-emploi touche 72 % de la main-d'œuvre. Le SMIG est de 52 000 FCFA / mois ([Benin Labour Market Profile 2025/2026](https://www.ulandssekretariatet.dk/wp-content/uploads/2024/12/Benin-LMP-2025-final.pdf)).
- **Togo** : plus de 90 % des emplois sont informels. 46 % des jeunes se déclarent sans emploi. Sur 1 000 diplômés universitaires togolais, à peine 100 accèdent à un emploi bien rémunéré ([Afrobarometer PP93 — juin 2025](https://www.afrobarometer.org/wp-content/uploads/2025/06/PP93-Education-en-hausse-et-chomage-en-embuscade-Limpasse-de-la-jeunesse-togolaise_Afrobarometer_24juin25.pdf)).
- **Cotonou & Lomé** : SMIG parmi les plus bas de la zone CFA (~52 000 FCFA, [OpenShores 2026](https://www.openshores.co/blog/benin/cotonou/salaires-a-cotonou)).

**Ce que représente 300 000 FCFA pour un pro de Lomé ou Cotonou :**

| Métrique | Équivalent 300 000 FCFA |
|---|---|
| SMIG togolais / béninois | ≈ 5.7 mois de salaire minimum |
| Loyer mensuel quartier populaire Lomé | 8 à 12 mois |
| Loyer mensuel quartier populaire Cotonou | 6 à 10 mois |
| Scolarité enfant collège public sur 1 an | 2 à 3 enfants |
| Coût d'un fauteuil de coiffure pro complet | 1 fauteuil installé |
| Coût d'un onduleur + batterie pour atelier | Setup complet 24h sans coupure |
| Stock matière première salon de couture | 3 à 4 mois |

Douleurs concrètes documentées :
1. **Manque de capital pour grandir** : 78 % des micro-entrepreneurs ouest-africains n'ont jamais eu accès à un crédit formel ([Banque mondiale — Situation économique Togo](https://documents1.worldbank.org/curated/en/329991599079506564/pdf/Rapport-sur-la-Situation-Economique-du-Togo-Dynamiser-l-Investissement-Prive-Pour-Plus-de-Croissance-et-d-Emploi.pdf)).
2. **Impayés clients** : 1 chantier sur 4 finit avec un solde non réglé (estimation chambres des métiers AOC).
3. **Saisonnalité** : revenus +200 % en saison mariages/fêtes (octobre–décembre, mai–juin), -60 % en saison creuse (août, février).
4. **Coût d'acquisition client** : un pro informel dépense en moyenne 15 000 à 25 000 FCFA/mois en transport pour démarcher.
5. **Pression familiale** : la solidarité africaine — superbe culturellement — devient une saignée économique pour le pro qui décolle. La tontine est un amortisseur structurel ([Persée — Les tontines béninoises](https://www.persee.fr/doc/tiers_0040-7356_1989_num_30_118_3836)).

**Interprétation pour le copywriting** : 300 000 FCFA, c'est pas un cadeau. C'est un airbag. C'est le mois où tu peux dire non à un client qui veut payer moitié prix. C'est l'onduleur que tu repoussais depuis 2 ans. C'est le frigo neuf pour le restau. C'est l'apprenti que tu peux enfin payer correctement.

### 2.3 Mécaniques de récompense qui marchent en Afrique

**Cas Wave — Côte d'Ivoire** : programme "Wave Cadeaux" lancé en 2025. Les marchands cumulent des paiements (≥ 350 FCFA par transaction, jusqu'à 10 étapes/semaine), et reçoivent des **cartes à gratter virtuelles aléatoires**. Résultat : engagement client ×3 sur le trimestre de lancement ([Wave — Conditions Wave Cadeaux](https://www.wave.com/fr/terms_rewards_path_ci/)).

**Cas Wasoko (ex-Sokowatch) — Kenya & expansion** : crédit revolving conditionné à la régularité des commandes. Les boutiquiers fidèles voient leur ligne de crédit augmenter automatiquement. Résultat : **commandes ×3, volume de ventes ×2** ([Afrobility transcript #65](https://afrobility.substack.com/p/transcript-65-wasoko-sokowatch-how)).

**Cas Twiga Foods — Kenya** : avance d'achat aux vendeuses de marché. Paiement sous 24h. Résultat : **+30 % de ventes** côté agriculteurs fidélisés ([Today Africa — Inside Wasoko's Journey](https://todayafrica.co/inside-wasokos-journey/)).
...
- Tirage aléatoire parmi éligibles → chacun reste dans la course en faisant son travail. Pas de comparaison interpersonnelle. **Le hasard est perçu comme la forme la plus pure d'équité** quand les critères d'éligibilité sont transparents.

C'est exactement la logique tontinière, transposée numériquement : tu cotises (= tu travailles sérieusement), tu es dans le pot, ton tour viendra peut-être ce mois-ci.

### 2.4 Cas concrets — pros AOC qui ont scalé

Le pattern récurrent dans les portraits *Jeune Afrique*, *RFI Afrique économie*, *Sika Finance* :
1. Démarrage solo avec ≤ 100 000 FCFA de capital.
2. Phase 1–3 ans : réputation locale, bouche à oreille de quartier.
3. **Déclic capital** : prêt familial, tontine, ou aide externe → achat d'un équipement structurant (machine, véhicule, frigo, local).
4. Embauche du premier apprenti.
5. 5–7 ans : 2–5 salariés, atelier identifié, clientèle régulière.

Le "déclic capital" est le goulot. C'est très exactement là où la Bourse de Croissance s'insère : **fournir le déclic à des pros déjà sérieux, sans dette, sans intérêts, sans collatéral, sans ce que demanderait une banque qu'ils n'ont pas**.

### 2.5 Le mot "Bourse" — décryptage culturel

Au Togo et au Bénin, "Bourse" a trois résonances :
1. **Bourse d'études** : ce que reçoit l'étudiant méritant. Une reconnaissance par une institution sérieuse. Connotation : sérieux, mérite, accompagnement.
2. **La bourse / le grand marché** (Dantokpa à Cotonou, Grand Marché à Lomé) : là où circule l'argent réel, là où tu vas chercher de quoi vivre.
3. **La bourse personnelle** : l'argent qu'on a en poche, le portefeuille.

Le mot "Bourse" capte donc trois choses simultanément : *mérite + circulation économique + réalité tangible de l'argent*. Aucun autre mot français ne fait ça.

Comparaisons :
- "Prix" : connote la compétition + le hasard pur (prix à gagner, prix de la loterie) — trop léger, pas de mérite.
- "Concours" : connote l'examen, le jury, la subjectivité — trop scolaire, biais favoritisme.
- "Récompense" : juste, mais générique. Manque la dimension "accompagnement vers la croissance".
- "Bonus" : connote l'extra, le supplément — pas la transformation.

**"Bourse de Croissance" gagne** parce que ça dit : *on reconnaît ton mérite + on te donne du capital pour grandir + c'est de l'argent réel*.

---

## 3. STORYTELLING — 3 PERSONNAGES

### 3.1 Kodjo — mécanicien moto, 32 ans, Akpakpa (Cotonou)
...
Awa tient un maquis à l'entrée nord de Dantokpa. Riz au gras, akassa, poulet braisé, sauce arachide. Elle ouvre à 5h pour le petit-déjeuner des manutentionnaires. Elle ferme à 22h. Sept jours sur sept, sauf les enterrements de famille.
...
300 000 FCFA. Awa pleure, mais devant le client qui attend son riz. Elle dit pardon, sert le plat, finit son service. À 22h, elle s'assied avec son cahier.
...
## 4. COPYWRITING — 3 VERSIONS CHAQUE

### 4.1 Hero page Récompenses — section Bourse
...
> **Bourse de Croissance — 300 000 FCFA chaque mois pour le pro qui mérite vraiment.**
>
> ---
>
...
> ---
>
> **Le principe : pas le plus connu. Le plus sérieux.**
>
...
> - Si tu as un profil complet (photo, métier, ville, quartier, numéro WhatsApp)
>
> Si tu remplis tous les critères, tu es dans le pot. Le 30 du mois à 18h, on tire au sort. Un nom au Togo. Un nom au Bénin. Notif sur ton téléphone dans la minute. Virement bancaire ou Mobile Money sous 48h.
>
> ---
>
...
> 7. Pas déjà gagné dans les 3 derniers mois (on fait tourner)
> 8. Tu suis @wolomarket sur TikTok
> 9. Tu suis @schealtiellawson sur TikTok
>
> ---
>
> **Pourquoi un tirage au sort plutôt qu'un concours.**
>
> Parce qu'un concours en Afrique de l'Ouest, on sait comment ça finit. Le plus médiatique gagne. Celui qui a un cousin au comité gagne. Celui qui paye un avis gagne. On voulait pas ça.
>
> Le tirage au sort parmi des éligibles **vraiment sérieux**, c'est la seule manière équitable. Toi tu fais ton travail, l'algorithme constate, et le hasard ne triche pas. Le mécano discret d'Adidogomé a exactement les mêmes chances que la couturière star de Cotonou — du moment qu'ils respectent les critères.
>
> ---
>
> **Ce que 300 000 FCFA change concrètement.**
>
> Pour un mécano : un compresseur neuf, une caisse à outils complète, le toit de l'atelier réparé.
>
> Pour une restauratrice : un frigo neuf, un brûleur professionnel, trois mois de matière première sécurisés.
>
> Pour un électricien : un multimètre pro, le remboursement d'une dette, la scolarité d'un enfant.
>
> Pour une couturière : une machine industrielle, un stock de tissus haute qualité, l'achat d'un mannequin de couture.
>
> 300 000 FCFA, c'est six mois de SMIG. C'est l'investissement qui débloque la croissance. C'est l'écart entre survivre et avancer.
>
> ---
>
> **Pas une charité. Une reconnaissance.**
>
...
#### Version 1 — Factuelle, étape par étape

> **Comment fonctionne la Bourse de Croissance — étape par étape.**
>
...
>
> Pas de candidature. Pas de dossier. Pas de jury. Tu fais ton travail, t'es dedans.

#### Version 2 — Conversationnelle, "tu" direct
...
#### Version 3 — Mécanique transparente avec FAQ

> **Comment ça marche — la mécanique transparente.**
>
> **Date du tirage** : le 30 de chaque mois, 18h GMT, heure de Lomé/Cotonou.
> **Méthode** : tirage aléatoire informatique, deux tirages séparés (un sur la base Togo, un sur la base Bénin).
> **Vérification** : la liste des éligibles est gelée à 18h00. Capture d'écran horodatée envoyée chaque mois aux deux gagnants.
> **Notification** : push notification + SMS + WhatsApp dans la minute qui suit.
...
### 4.3 Section "Pourquoi tu mérites"

#### Version A — Focus SÉRIEUX

> **Tu mérites parce que t'es sérieux.**
>
> Tu te lèves quand les autres dorment encore. Tu réponds au client à 21h alors que ta journée est finie depuis trois heures. Tu rappelles quand la pièce est arrivée. Tu refais gratos quand le chantier a un défaut, parce que pour toi un travail mal fait c'est pas un travail.
>
...
> **Tu mérites parce que t'es dévoué.**
>
> Ton métier c'est pas un boulot. C'est ce que tu fais bien parce que tu sais le faire bien. Tu transmets à ton apprenti ce que ton tonton t'a transmis. Tu refuses les bricoles. Tu prends le temps qu'il faut.
>
...
>
> Tes résultats parlent. Pas tes connexions.

---

### 4.4 Card "Mes chances de gagner ce mois" (checklist dashboard)

#### Phrase d'intro motivationnelle

> **Tes chances ce mois — sois sérieux, t'es dedans.**

#### Texte sous la checklist

> Coche tous les critères et tu rentres automatiquement dans le tirage du 30. Pas de bouton magique. Pas de "candidature". Ton travail te qualifie.

#### Texte si éligible

> **🟢 Tu es dans le tirage de ce mois.**
>
> Continue. Le 30 à 18h, l'algorithme tirera au sort. Un Togo, un Bénin. Si c'est toi, tu reçois 300 000 FCFA sous 48h.
> Garde ton activité, garde tes avis qui rentrent, garde tes étoiles. C'est ton mérite qui t'a mis dedans.

#### Texte si non éligible (avec critères manquants listés)
...
> - [ ] Profil complet
> - [ ] Activité < 14 jours
> - [ ] Suivre @wolomarket sur TikTok
> - [ ] Suivre @schealtiellawson sur TikTok
>
> Tu peux régler ça aujourd'hui. La porte n'est pas fermée — elle attend ton travail.

---

### 4.5 Notification gagnant

#### Push notif (60 caractères max)

> **300 000 FCFA pour toi. Bourse de Croissance — c'est toi.**
...
> **Salut [Prénom],**
>
> Le tirage de la Bourse de Croissance de [mois] vient d'être effectué.
>
> **C'est toi.**
>
...
> **Objet** : Tu viens de gagner la Bourse de Croissance — 300 000 FCFA
>
> Salut [Prénom],
>
...
>
> **Décide librement si tu veux qu'on annonce publiquement ton nom et ton métier**, ou si tu préfères rester anonyme. Pas de pression. Réponds à cet email.
>
...
### 4.6 Annonce publique du gagnant

#### Format Instagram — carrousel 5 slides (texte de chaque slide)

**Slide 1 (Or fond)**

> 🏆 LA BOURSE DE CROISSANCE
> [Mois] [Année]
> 300 000 FCFA × 2
> Tirage du 30

**Slide 2 (Dark fond, barre or gauche)**

> Pas le plus connu.
> Le plus sérieux.

**Slide 3 (Dark fond + photo gagnant Togo)**
...
> Avis ce mois : [X]
>
> "Citation courte du gagnant — 1 phrase brute."

**Slide 4 (Dark fond + photo gagnant Bénin)**
...
> **Objet** : On a 2 gagnants ce mois. [Prénom Togo] + [Prénom Bénin].
>
> Salut [Prénom],
>
...
> ---
>
> **Pourquoi je t'envoie ce mail ?**
>
> Parce que c'est important que tu saches comment ça se passe vraiment. Pas de jury. Pas de favoritisme. Pas d'enfumage. Un algorithme qui regarde ton travail, et un tirage le 30 à 18h pile.
>
> Si t'as pas gagné ce mois, ne sois pas découragé. Sois éligible. Sois dans le pot. Et continue.
>
> Si t'es éligible et que t'as pas gagné — c'est juste pas ton mois. Le pot tourne. Tu restes dedans tant que tu restes sérieux.
>
> Si t'es PAS encore éligible : connecte-toi, regarde ton dashboard, regarde ce qui te manque. Tout est listé. Personne te cache rien.
>
...
1. **"Le 30 du mois, à 18h, mon téléphone a vibré."**
...
> **Format type** : 30 secondes, vertical, sous-titres FR ouverts, musique ambiance atelier ou afrobeat lo-fi.

### Vidéo 1 — "Pas le plus connu. Le plus sérieux."

> **[0-3s]** Plan serré sur main d'artisan qui travaille (clé moteur, machine à coudre, fer à souder).
> *Voix off* : "En Afrique, qui gagne les concours ?"
>
> **[3-8s]** Coupe rapide sur affiches concours floues, jurys, célébrations.
...
> **[0-3s]** Téléphone qui vibre sur établi.
...
>
> **[18-25s]** Plan sur compresseur neuf installé.
...
> **[0-3s]** Caméra face, question directe au spectateur.
> "Toi, tu connais quelqu'un qui a gagné un concours fair en Afrique ?"
>
> **[3-8s]** Pause. Regard. "Moi non plus."
>
...
> **[0-3s]** Awa devant son maquis, foulard, tablier.
> "Je suis Awa. Maquis à Dantokpa. 4 enfants."
>
> **[3-10s]** Plan sur le service du matin.
...
> 5. Note ≥ 4.2★
> 6. Connecté < 14 jours
> 7. Pas gagné dans les 3 derniers mois
...
> **[0-3s]** Texte : "SMIG Togo : 52 000 FCFA / mois."
>
> **[3-8s]** Texte : "SMIG Bénin : 52 000 FCFA / mois."
>
...
> **[0-3s]** Plan sur Kodjo en train de visser.
...
>
> **[18-25s]** Compresseur neuf installé.
> "Aujourd'hui, compresseur neuf. Apprenti augmenté. Toit refait."
>
> **[25-30s]** Kodjo, regard caméra : "Pas le plus connu. Le plus sérieux."
...
> **[0-3s]** Issaka, gros plan, sérieux.
> "Issaka. Électricien. 28 ans de métier."
>
> **[3-10s]** Atelier, outils.
...
> **Cible** : nouveau pro venant de souscrire au Plan Pro 2 500 FCFA.

### Email 1 (J+0) — Bienvenue Pro + Bourse expliquée

> **Objet** : T'es Pro. Voici comment gagner 300 000 FCFA le mois prochain.
>
> Salut [Prénom],
>
...
>
> Chaque 30 du mois à 18h, l'algorithme tire au sort 1 gagnant Togo + 1 gagnant Bénin parmi les pros qui remplissent 9 critères. 300 000 FCFA versés sous 48h.
>
> **Tu veux être éligible dès ce mois ?** Connecte-toi maintenant à ton dashboard et complète ta checklist. C'est dans le menu "Récompenses".
>
> À demain.
>
...
> **Objet** : Kodjo a gagné 300 000 FCFA le mois dernier. Voici comment.
>
> Salut [Prénom],
>
> Hier je t'ai expliqué la Bourse. Aujourd'hui je te raconte Kodjo.
>
...
>
> Étape 1 : complète ton profil aujourd'hui.
> Étape 2 : demande à tes 3 prochains clients de mettre un avis.
>
> Le 30, on tire au sort.
>
> — Schealtiel

### Email 3 (J+3) — Comment maximiser tes chances

> **Objet** : Les 5 leviers pour entrer dans le tirage du 30
>
> Salut [Prénom],
>
> Voici les 5 actions concrètes que tu peux faire cette semaine pour maximiser tes chances :
>
...
>
> **5. Suis @wolomarket et @schealtiellawson sur TikTok.** C'est un critère.
>
> Tu fais ces 5 choses, t'es dans le pot du 30.
>
> — Schealtiel

### Email 4 (J+5) — Cas anticipé (avant le 1er tirage)

> **Objet** : Le 30, à 18h, on tire au sort. Tu peux être dedans.
>
> Salut [Prénom],
>
> Plus que [X] jours avant le tirage de [mois].
>
> Voici ce qui se passera :
> - 18h00 : la liste des éligibles est gelée
> - 18h00–18h05 : tirage automatique, 1 gagnant Togo, 1 gagnant Bénin
> - 18h05 : notifications envoyées aux 2 gagnants
> - 18h30 : appel téléphonique de notre équipe aux gagnants
> - Sous 48h : virement de 300 000 FCFA effectué
> - J+5 : annonce publique (si les gagnants l'autorisent)
>
> **Si tu remplis les critères, tu es dans le pot.** L'algorithme ne sait pas qui tu es. Il regarde tes chiffres. Si t'es éligible, t'as exactement la même chance que tous les autres éligibles.
>
> Vérifie ton statut dans ton dashboard → Récompenses → Bourse de Croissance.
>
> — Schealtiel

### Email 5 (J+7) — Compte à rebours tirage

> **Objet** : J-X. Ton statut Bourse de Croissance — vérifie.
>
> Salut [Prénom],
>
> Plus que [X] jours.
>
> **Ton statut actuel** : [éligible 🟢 / non éligible 🟡 avec listing des manques]
>
> Si t'es 🟢 : tu n'as rien à faire. Continue à bosser. Le 30 à 18h, l'algorithme prend ta carte et la met dans le pot avec les autres éligibles.
>
> Si t'es 🟡 : il te reste [X] jours pour combler les critères manquants. Voilà la liste.
> - [Critère manquant 1]
> - [Critère manquant 2]
> - ...
>
> Tu te connectes, tu règles, et tu rentres dans le pot.
>
> 300 000 FCFA. Le 30 à 18h. Peut-être toi.
>
> — Schealtiel
...
| J-24 | 15/05 | TikTok | Reel | "Tu connais quelqu'un qui a gagné un concours fair en Afrique ?" (Vidéo 4) |
| J-23 | 16/05 | Instagram | Carrousel | Storytelling Kodjo (5 slides) |
| J-22 | 17/05 | WhatsApp Status | Texte | "C'est pas le plus connu qui gagne." (#2) |
...
| J-14 | 25/05 | TikTok | Reel | "6 mois de SMIG en 48h." (Vidéo 7) |
| J-13 | 26/05 | Instagram | Story | "J-13 avant le 1er tirage" |
| J-12 | 27/05 | TikTok | Reel | "Pourquoi pas un concours classique" (Vidéo 9) |
| J-11 | 28/05 | WhatsApp Status | Texte | "L'algo regarde ton travail." (#6) |
| J-10 | 29/05 | Instagram | Carrousel | Storytelling Issaka |
| J-9 | 30/05 | TikTok | Reel | "Mécano d'Akpakpa." (Vidéo 8) |
| J-8 | 31/05 | Instagram | Post Or | "Plan Pro à 2 500. Tu rentres dans le pot." |
| J-7 | 01/06 | TikTok | Reel | Storytime Issaka (Vidéo 10) |
| J-6 | 02/06 | Instagram | Story | "J-6 — vérifie tes critères" |
| J-5 | 03/06 | TikTok | Reel | Compilation 3 témoignages |
| J-4 | 04/06 | Instagram | Carrousel | "FAQ Bourse — 5 questions" |
| J-3 | 05/06 | WhatsApp Status | Texte | "Demande à ton client de mettre un avis." (#9) |
| J-2 | 06/06 | TikTok | Reel | Compte à rebours visuel |
...
### 9.3 INTERDIT — purgé totalement

- ❌ "Sans piston" (vide, déjà purgé du site)
- ❌ "Talent" → préférer "travail", "métier", "pros", "sérieux"
- ❌ "Agent terrain" / "agent" (côté utilisateur) → "parrainage" / "affiliation"
- ❌ "Schealtiel" / "Kpomblawoun" sur tout visuel social
- ❌ Tout contenu politique (États, figures, institutions, partis)
- ❌ Buzzwords corporate : "performance", "engagement", "synergies", "ecosystem", "scalable", "disruption", "valoriser le talent"
- ❌ "Travailleur informel" (péjoratif/condescendant) → "pro", "prestataire", "artisan"
- ❌ Tournures victimisantes : "Si toi aussi tu es laissé pour compte…" → préférer la dignité

### 9.4 Ton & posture

- **Tutoiement** systématique (pas vous)
...
- **Kodjo** — mécanicien moto, 32 ans, Akpakpa (Cotonou)
- **Awa** — restauratrice maquis, 38 ans, Dantokpa (Cotonou)
- **Issaka** — électricien, 45 ans, Adidogomé (Lomé)
- **Madame Adjo** — couturière, 52 ans, Bè (Lomé)
- **Akossiwa** — photographe événements, 28 ans, Tokoin (Lomé)

### 9.6 Lieux canoniques

- **Cotonou** : Dantokpa, Akpakpa, Cotonou Nord, Cadjèhoun, Calavi
- **Lomé** : Bè, Adidogomé, Tokoin, Agoè, Doulassamé

### 9.7 Chiffres précis (à ne pas arrondir)
...
- **Tirage le 30 à 18h** (heure Lomé/Cotonou)
- **Versement sous 48h**

### 9.8 Identité visuelle — rappel

- Fond : **Dark #0f1410** ou **Crème #F8F6F1** (jamais sur réseaux sociaux, seulement site web)
- Accent : **Or #E8940A**
- **INTERDIT** : vert #1B7A4A sous toute forme
- Typo visuels sociaux : **Fraunces** (titres), **Poppins** (body/CTA), **Space Mono** (eyebrow/data)
- Logo : cercle noir + W or (jamais inversé)
- Visuels créés en **HTML** (jamais Canva)

---

## 10. CONCLUSION — CE QUI REND LA BOURSE UNIQUE

### 10.1 Comparaison avec les alternatives
...
| Sokowatch/Wasoko crédit | Boutiquiers B2B | Crédit revolving conditionné | Non disponible Togo/Bénin, B2B uniquement |
| Tontine traditionnelle | Quartier/communauté | Rotation pot mensuel | Limité au cercle social, plafonné |

### 10.2 Les 5 attributs uniques de la Bourse de Croissance

1. **Sans dette, sans intérêts, sans collatéral.** C'est de l'argent rendu, pas prêté.
2. **Sans jury, sans favoritisme.** Algorithme + tirage aléatoire = équité brute.
3. **Mensuel récurrent.** Ce n'est pas un coup unique. C'est une perspective de revenu complémentaire pour tout pro qui devient et reste sérieux.
4. **Montant transformateur** (300 000 FCFA ≈ 6 mois de SMIG). Pas un cadeau symbolique.
5. **Critères transparents et auditables**. 9 critères publics, dashboard temps réel, capture d'écran horodatée du tirage.

### 10.3 Promesse de marque

> *La Bourse de Croissance, c'est le pacte le plus simple qu'on puisse proposer à un pro africain : tu fais ton travail bien, on le mesure, et chaque mois on en récompense deux d'entre vous avec ce qu'il faut pour grandir. Pas un concours. Pas une charité. Une reconnaissance.*

---

## SOURCES CITÉES

1. [Benin Labour Market Profile 2025/2026 — Ulandssekretariatet](https://www.ulandssekretariatet.dk/wp-content/uploads/2024/12/Benin-LMP-2025-final.pdf)
2. [Afrobarometer PP93 — Education en hausse, chômage en embuscade (jeunesse togolaise, juin 2025)](https://www.afrobarometer.org/wp-content/uploads/2025/06/PP93-Education-en-hausse-et-chomage-en-embuscade-Limpasse-de-la-jeunesse-togolaise_Afrobarometer_24juin25.pdf)
3. [Salaires à Cotonou 2026 — OpenShores](https://www.openshores.co/blog/benin/cotonou/salaires-a-cotonou)
4. [Banque mondiale — Rapport situation économique Togo (Dynamiser l'investissement privé)](https://documents1.worldbank.org/curated/en/329991599079506564/pdf/Rapport-sur-la-Situation-Economique-du-Togo-Dynamiser-l-Investissement-Prive-Pour-Plus-de-Croissance-et-d-Emploi.pdf)
5. [Wave Cadeaux — Conditions générales (programme fidélisation)](https://www.wave.com/fr/terms_rewards_path_ci/)
6. [Wave Côte d'Ivoire — Campagne paiement marchand Adjamé (Life Radio)](https://liferadio.ci/abidjan-wave-ci-investit-le-marche-forum-dadjame-pour-lancer-sa-campagne-promotionnelle-paiement-marchand/)
7. [Persée — L'épargne informelle en Afrique : les tontines béninoises (revue Tiers-Monde)](https://www.persee.fr/doc/tiers_0040-7356_1989_num_30_118_3836)
8. [Afrobility podcast #65 — Wasoko/Sokowatch B2B retail platform Africa](https://afrobility.substack.com/p/transcript-65-wasoko-sokowatch-how)
9. [Today Africa — Inside Wasoko's Journey](https://todayafrica.co/inside-wasokos-journey/)
10. [TechCrunch — Sokowatch raises $14M to digitize Africa's informal B2B supply chain](https://techcrunch.com/2020/02/23/sokowatch-raises-14m-to-digitize-africas-informal-b2b-supply-chain/)
11. [ScienceDirect — Increasing worker motivation using a reward scheme with probabilistic elements (OBHDP 2023)](https://www.sciencedirect.com/science/article/abs/pii/S0749597823000328)
12. [Plus que PRO — Plateforme avis sécurisés blockchain pour artisans](https://www.relations-publiques.pro/207491/artisans-prestataires-de-services-plus-que-pro-la-premiere-plateforme-qui-utilise-la-technologie-blockchain-pour-securiser-les-avis.html)
13. [Sika Finance — Paiements marchands Wave Afrique inclusion financière](https://www.sikafinance.com/marches/paiements-marchands-wave-accelere-sa-marche-vers-l-inclusion-financiere_36014)
14. [Dakaractu — Wave paiements marchands inclusion financière Afrique](https://www.dakaractu.com/Le-Paiements-marchands-de-Wave-un-nouveau-levier-pour-accelerer-l-inclusion-financiere-en-Afrique_a222808.html)
15. [Banque mondiale — Vue d'ensemble Togo](https://www.banquemondiale.org/fr/country/togo/overview)
