...
| Temps | Contenu |
|---|---|
| 0-5 min | Accueil. Tour de table rapide : prénom, ville, quartier. |
| 5-20 min | Module 1 : WOZALI, ce que c'est, ce qu'on résout. Démo live du profil sur écran. |
| 20-30 min | Module 2 : la rémunération. Le calcul concret. Questions sur les paliers. |
...
| Temps | Contenu |
|---|---|
| 0-5 min | Rappel : lancement officiel demain. Ce qui change à partir du 1er juillet. |
...
## Règles pour toutes les sessions

- Caméra activée si possible
- Questions dans le chat pendant les présentations, à voix haute pendant les espaces dédiés
- Enregistrement partagé dans le groupe après chaque session pour ceux qui n'ont pas pu assister
- Groupe WhatsApp actif avant, pendant et après chaque session pour les questions qui restent
